  ...
  return (
    <Stack.Navigator screenOptions={headerOptions(colors)}>
      ...
      <Stack.Screen
        ...
        options={{ title: "Configuracion del sistema" }}
      />
    </Stack.Navigator>
  );
}
...
function TabIcon({ name, focused, color }) {
  ...
  return (
    <View style={styles.tabIconWrap}>
      {focused && (
        <View
          style={[styles.tabIconPill, { backgroundColor: colors.primaryLight }]}
        />
      )}
    ...
    >
      ...
      {!isPatient && (
        <Tab.Screen
          ...
          options={{
            ...
            tabBarLabel: ({ focused }) => (
              <TabLabel label="Pacientes" focused={focused} />
            ),
          }}
        />
      )}
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <TabLabel
              label={isPatient ? "Mis Citas" : "Agenda"}
              focused={focused}
            />
          ),
        }}
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarLabel: ({ focused }) => (
            <TabLabel
              label={isPatient ? "Mis Pagos" : "Cobros"}
              focused={focused}
            />
          ),
        }}
